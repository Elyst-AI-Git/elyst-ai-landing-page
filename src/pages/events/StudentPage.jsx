        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            <div className="md:col-span-8 group relative bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-xl transition-all border border-[#7fb8ac]/10 h-72 md:h-80">
              <img className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" src="https://blogs-cdn.imagine.art/Lighting_Static_fc6de099d4.webp" alt="AI Video Generation" />
            ...
            <div className="md:col-span-4 group relative bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-xl transition-all border border-[#7fb8ac]/10 h-72 md:h-80">
              <img className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" src="https://images.unsplash.com/photo-1620712943543-bcc4688e7485?q=80&w=765&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="AI Prompting" />
            ...
            <div className="md:col-span-4 group relative bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-xl transition-all border border-[#7fb8ac]/10 h-72 md:h-80">
              <img className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" src="https://i.redd.it/whats-your-opinion-on-ai-generated-posters-v0-cquazb2soyfe1.png?width=1024&format=png&auto=webp&s=ec08a71a62a2fff90669fdf4b3f05d2a647c2bcf" alt="Creating Poster" />
            ...
            <div className="md:col-span-8 group relative bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-xl transition-all border border-[#7fb8ac]/10 h-72 md:h-80">
              <img className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" src={websiteBuilding} alt="Website Development" />
